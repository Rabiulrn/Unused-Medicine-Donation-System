...
<body>
        ...
        <tbody class="text-center">
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo '<input type="hidden" name="pharmaName" value=' . $row["pharmaName"] . '>';
    ...
    if (isset($_REQUEST['close'])) {
        $sql = "DELETE FROM pharmadonation WHERE pharmaID = {$_REQUEST['pharmaID']}";
    ...
    ?>
        ...
        ?>
        <?php
        $sql = "UPDATE pharmadonation SET status = 'Assigned To NGO' WHERE pharmaID={$_REQUEST['pharmaID']}";
        $res = $conn->query($sql);
        ?>

        <script>
            window.location.href = 'pharma.php';
        </script>
    <?php
    }
    ?>
                    ...
                    <div class="form-group p-5">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                ...
                                <input type="text" name="pharmaID" class="form-control mt-1 mb-2 text-center text-danger" value="<?php if (isset($_REQUEST['pharmaID'])) echo $_REQUEST['pharmaID']; ?>" readonly>
                            </div>
                            <div class="col-sm-10">
                                <label for="name">Pharmaceutical Donor</label><br>
                                <input type="text" name="pharmaName" class="form-control mt-1 mb-2" value="<?php if (isset($_REQUEST['pharmaName'])) echo $row['pharmaName']; ?>">
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <label for="area">Address</label><br>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <a href="pharma.php" class="btn btn-warning "><i class="fas fa-sync pr-2"></i>Refresh</a>
                            </div>
                            <?php
                            if (isset($msg)) {
                                // code...
