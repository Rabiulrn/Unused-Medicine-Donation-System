...
<?php
// echo $_GET['id'];
$sql="SELECT donorID,donor,medicine,quantity,`address`,upzilla,district,executive,phone,daate,`status` FROM executive_assign_request WHERE donorID={$_REQUEST['id']}";
    $res=$conn->query($sql);
    //$row=$res->fetch_assoc();
