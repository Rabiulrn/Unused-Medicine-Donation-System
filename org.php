        ...
        <div class="row mt-4">
            ...
            <div class="col-lg-6 mt-5" id="header">
                ...
                <p>Any Organization can donate their unused medicine on our website easily. If your organization want to
                    donate unused or excessive medicines, simply <a href="index.php#contact" style="text-decoration: none; font-style: italic;">contact us </a> or just hit the Donate
                    button.</p>
            </div>
        </div>
    </div>
        ...
        <form class="form-group border border-info p-4 mt-5 mb-5" method="POST" action="" id="form">
            ...
            <div class="text-info">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <label for="upzilla" class="mt-3"><i class="fas fa-location-arrow pr-2"></i>Upazila/Thana</label>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <label for="medicine" class="mt-3 "><i class="fas fa-sort-amount-up-alt pr-2 text-info"></i>Quantity
